...
private constructor() {
  ...
  private fun createPreviewBuffer(previewSize: Size): ByteArray {
    ...
    val sizeInBits = previewSize.getHeight() * previewSize.getWidth() * bitsPerPixel
  ...
  companion object {
    ...
    private fun selectSizePair(camera: Camera, desiredWidth: Int, desiredHeight: Int): SizePair? {
      ...
      for (sizePair in validPreviewSizes) {
        ...
        val diff = Math.abs(size.getWidth() - desiredWidth) + Math.abs(size.getHeight() - desiredHeight)
        if (diff < minDiff) {
